...
INPUT_FILE = Path("data/raw/2026/7.progreso_curricular/curricula_after_school_2026.xlsx")
OUTPUT_DIR = Path("data/processed/2026/7.progreso_curricular")
