...
INPUT_FILE = Path("data/raw/2026/4.calificaciones_area_competencia/comparativa_ventanilla_proyectos.xlsx")
OUTPUT_DIR = Path("data/processed/2026/4.calificaciones_area_competencia")
...
def transformar_archivo(input_file: Path) -> pd.DataFrame:
    ...
    bd_final["EVALUACION__c"] = np.where(
        (bd_final["ANIO"] == 2026) & (bd_final["MOMENTO"] == "LB"),
        "2026-I",
        "2026-II"
    )
