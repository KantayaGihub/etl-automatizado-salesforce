...
ARCHIVO = Path("data/raw/2026/matricula/Consolidado_Matricula_AfterSchool.xlsx")

# 5. Configuración de SALIDA
CARPETA_SALIDA = Path("data/processed/2026/matricula")
CARPETA_SALIDA.mkdir(parents=True, exist_ok=True)

SALIDA = CARPETA_SALIDA / "consolidado_matricula_afterschool_2026_UNICO.csv"
SALIDA_CALIDAD = CARPETA_SALIDA / "consolidado_matricula_afterschool_2026_CALIDAD.xlsx"
...
def transformar_fecha_registro(valor):
    ...
    if s in meses_map_2026:
        mes_num = meses_map_2026[s]
        return pd.Timestamp(2026, mes_num, 1)
