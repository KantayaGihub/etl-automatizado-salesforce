...
FILE_NAME = os.getenv(
    ...
    "01 CRONOGRAMA DE VOLUNTARIADO 2026.xlsx"
)

RAW_DIR = Path("data/raw/2026/10.asistencia_actividades_vivenciales")
RAW_FILE_PATH = RAW_DIR / "asistencia_actividades_vivenciales_2026.xlsx"
