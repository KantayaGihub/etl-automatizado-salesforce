...
NOMBRE_CARPETA = "01 REGULAR - ASISTENCIAS 2026"

# Definimos las rutas base en la nube
CARPETA = Path("data/raw/2026/asistencia_regular")
CARPETA_SALIDA = Path("data/processed/2026/asistencia_regular")
ARCHIVO_SALIDA = CARPETA_SALIDA / "asistencias_2026_limpio.csv"
