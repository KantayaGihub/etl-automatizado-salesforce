...
# ============================================================
ARCHIVOS_POR_ANIO = {
    "2025": Path("data/processed/2025/10.asistencia_actividades_vivenciales/BD_asistencia_actividades_vivenciales.csv"),
    "2026": Path("data/processed/2026/10.asistencia_actividades_vivenciales/BD_asistencia_actividades_vivenciales.csv"),
}

CARPETA_SALIDA = Path("data/consolidated/asistencia_actividades_vivenciales")
ARCHIVO_SALIDA = CARPETA_SALIDA / "BD_asistencia_actividades_vivenciales.csv"
...
def main():
    print("=== CONSOLIDACIÓN ASISTENCIA ACTIVIDADES VIVENCIALES ===")
