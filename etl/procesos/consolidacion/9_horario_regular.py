...
# ============================================================
ARCHIVOS_POR_ANIO = {
    "2025": Path("data/processed/2025/9.horario_regular/base_horaria_final.csv"),
    "2026": Path("data/processed/2026/9.horario_regular/base_horaria_final.csv"),
}

CARPETA_SALIDA = Path("data/consolidated/horario_regular")
ARCHIVO_SALIDA = CARPETA_SALIDA / "base_horaria_final.csv"
...
def main():
    print("=== CONSOLIDACIÓN HORARIO REGULAR ===")
