...
# ============================================================
ARCHIVOS_POR_ANIO = {
    "2025": Path("data/processed/2025/4.calificaciones_area_competencia/BD_Promedios_Areas_LB_LS_Consolidado.csv"),
    "2026": Path("data/processed/2026/4.calificaciones_area_competencia/BD_Promedios_Areas_LB_LS_Consolidado.csv"),
}

CARPETA_SALIDA = Path("data/consolidated/calificaciones_area_competencia")
ARCHIVO_SALIDA = CARPETA_SALIDA / "BD_Promedios_Areas_LB_LS_Consolidado.csv"
...
def main():
    print("=== CONSOLIDACIÓN CALIFICACIONES ÁREA COMPETENCIA ===")
